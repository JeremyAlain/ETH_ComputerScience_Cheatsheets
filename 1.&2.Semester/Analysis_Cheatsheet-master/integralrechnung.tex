...
\begin{corollary}[Hauptsatz mit Kettenregel]$\frac{d}{dx}\int_{x^2}^{ax} F(x) = \frac{d}{dx}(F(ax) - F(x^a)) = F'(ax)\frac{d}{dx}(ax)-F'(x^2)\frac{d}{dx}(x^2)$
...
$\bullet$ $\int_0^{\pi^2} \sin{\sqrt{x}} \,dx$ $ \underset{u = \sqrt{x} \ \Rightarrow  x=u^2 \ \Rightarrow  \frac{dx}{du}=2u \ \Rightarrow  dx=2udu}{=} $ $\int_{0}^{\pi} \sin(u)2u\ du$ \\

$\bullet$ $\int_0^2 x \sqrt{x+1}^3 \,dx$
